...
export default function ForgotPasswordForm({ onBack }) {
  ...
  if (sent) {
    return (
      <AuthLayout>
        <div className="w-full bg-white/95 dark:bg-gray-900/95 backdrop-blur rounded-3xl shadow-2xl p-6 space-y-4 animate-fade-scale-in">
  ...
  return (
    <AuthLayout>
      ...
      <form onSubmit={handleSubmit} className="w-full bg-white/95 dark:bg-gray-900/95 backdrop-blur rounded-3xl shadow-2xl p-8 space-y-6 animate-fade-scale-in">
        <div className="text-center">
        ...
        <p className="text-center text-sm text-gray-500 dark:text-gray-400">
          <button type="button" onClick={onBack} disabled={loading} className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 font-medium transition disabled:opacity-50">
            Volver al inicio de sesión
          </button>
        </p>
      </form>
