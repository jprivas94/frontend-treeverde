...
export default function ResetPasswordForm({ token, onSuccess }) {
  ...
  if (success) {
    return (
      <AuthLayout>
        <div className="w-full bg-white/95 backdrop-blur rounded-3xl shadow-2xl p-8 space-y-6 text-center animate-fade-scale-in">
  ...
  return (
    <AuthLayout>
      ...
      <form onSubmit={handleSubmit} noValidate className="w-full bg-white/95 backdrop-blur rounded-3xl shadow-2xl p-8 space-y-6 animate-fade-scale-in">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-2.5 border rounded-xl outline-none transition focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 ${
                  confirmPassword && newPassword !== confirmPassword
                    ? 'border-red-400 bg-red-50'
                    : 'border-gray-200 bg-gray-50/60 hover:bg-white focus:bg-white'
                }`}
