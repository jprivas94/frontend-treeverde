...
export default function RegisterForm({ onSwitch, invite }) {
  ...
  return (
    <AuthLayout>
      ...
      <form onSubmit={handleSubmit} noValidate className="w-full bg-white/95 dark:bg-gray-900/95 backdrop-blur rounded-3xl shadow-2xl p-6 space-y-4 animate-fade-scale-in">
        <div className="text-center">
          <div className="mx-auto w-10 h-10 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-100 dark:border-emerald-900 flex items-center justify-center mb-2">
