...
export default function AuthSkeleton() {
  return (
    <div className="w-full bg-white/95 backdrop-blur rounded-3xl shadow-2xl p-8 space-y-6 animate-fade-scale-in">
      {/* Logo + títulos */}
      <div className="flex flex-col items-center">
        ...
        <div className="mt-2 w-48 h-3 bg-gray-100 rounded animate-pulse" />
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-1.5">
          <div className="w-24 h-2.5 bg-gray-200 rounded-full animate-pulse" />
          <div className="h-11 bg-gray-100 rounded-xl animate-pulse" />
        </div>
      </div>

      {/* Botón */}
      <div className="h-11 bg-emerald-100 rounded-xl animate-pulse" />
